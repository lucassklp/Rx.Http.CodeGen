...
namespace Keycloak.Dict.Models
{
    public class RealmRepresentation
    {
        ...
        public List<Dictionary<string, object>> ClientProfiles { get; set; }
        [JsonProperty("clientPolicies")]
        public List<Dictionary<string, object>> ClientPolicies { get; set; }
        [JsonProperty("users")]
        ...
        public Dictionary<string, object> SocialProviders { get; set; }
        [JsonProperty("applicationScopeMappings")]
        public Dictionary<string, object> ApplicationScopeMappings { get; set; }
